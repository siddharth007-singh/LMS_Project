...
const AddCource = () => {
    ...
    const createCourseHandler = async() => {
        await createCourse({courceTitle, category});
    };
    ...
    <div className="flex-1 mx-10">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" onClick={() => navigate("/admin/cources")}>
            Back
          </Button>
          <Button disabled={isLoading} onClick={createCourseHandler}>
            {
                isLoading ? <Loader2 className="w-5 h-5 animate-spin" /> : "Create Course"
            }
          </Button>
        </div>
      </div>
